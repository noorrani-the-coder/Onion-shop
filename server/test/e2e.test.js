...
Rates for 100 kg`;
    ...
    if (fs_1.default.existsSync(genData.imagePath)) {
        const meta = await (0, sharp_1.default)(genData.imagePath).metadata();
        ...
        console.log(`   - File Size: ${(fs_1.default.statSync(genData.imagePath).size / 1024).toFixed(1)} KB`);
