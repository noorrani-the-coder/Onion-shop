...
const marketParser_1 = require("../src/services/parser/marketParser");
let passed = 0;
let failed = 0;
...
Weather ☁️
Rates for 100 kg`;
const r1 = (0, marketParser_1.parseMarketReportDeterministic)(formatA).normalized;
...
Sales: Slow
Weather: Cloudy`;
const r2 = (0, marketParser_1.parseMarketReportDeterministic)(formatB).normalized;
...
ARRIVAL 65326
TRUCK 325+`;
const r3 = (0, marketParser_1.parseMarketReportDeterministic)(formatC).normalized;
...
Cloudy
Rate per 100kg`;
const r4 = (0, marketParser_1.parseMarketReportDeterministic)(formatD).normalized;
...
console.log('\n--- TEST 5: Rates written using "to" ---');
const r5 = (0, marketParser_1.parsePriceRange)('Big Onion: Rs. 4000 to 4200');
assert(r5?.min === 4000 && r5?.max === 4200 && r5?.display === '4000-4200', '4000 to 4200 parsed into range');
// TEST 6: Rates written using "/"
console.log('\n--- TEST 6: Rates written using "/" ---');
const r6 = (0, marketParser_1.parsePriceRange)('Extra Big 4300/4500');
...
const r7 = (0, marketParser_1.parseMarketReportDeterministic)(noWeatherMsg).normalized;
...
const r8 = (0, marketParser_1.parseMarketReportDeterministic)(noTruckMsg).normalized;
...
const r9 = (0, marketParser_1.parseMarketReportDeterministic)(extraVarietyMsg).normalized;
...
assert((0, marketParser_1.parseDate)('Date: 22 Aug 2026').isoDate === '2026-08-22', '22 Aug 2026 parsed');
assert((0, marketParser_1.parseDate)('22.08.2026').isoDate === '2026-08-22', '22.08.2026 parsed');
assert((0, marketParser_1.parseDate)('22/08/2026').isoDate === '2026-08-22', '22/08/2026 parsed');
...
const r11 = (0, marketParser_1.parseMarketReportDeterministic)(emojiMsg).normalized;
...
const r12 = (0, marketParser_1.parseMarketReportDeterministic)(abbrevMsg).normalized;
...
const r13 = (0, marketParser_1.parseMarketReportDeterministic)(unrelatedMsg);
...
const r14 = (0, marketParser_1.parseMarketReportDeterministic)(partialMsg).normalized;
...
// TEST 15: Single rate value
console.log('\n--- TEST 15: Single rate without range ---');
const singleRate = (0, marketParser_1.parsePriceRange)('Vijayapura 3700');
assert(singleRate?.min === 3700 && singleRate?.max === 3700 && singleRate?.display === '3700', 'Single rate 3700 normalized');
console.log('\n======================================================');
